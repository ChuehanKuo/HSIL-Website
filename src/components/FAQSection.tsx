...
const faqs = [
  ...
  { q: "優勝隊伍有什麼獎勵？", a: "台灣站的前兩名隊伍將代表台灣進入哈佛 HSIL 的全球 Bootcamp 培訓計畫（共八週，全程線上）。計畫分為三階段：Bootcamp I（兩週，全球入選團隊）→ Bootcamp II（兩週，全球前 20 強）→ Venture Building Immersion（四週，全球前 10 強），最終於 Demo Day 向投資人與產業領袖發表方案。" },
