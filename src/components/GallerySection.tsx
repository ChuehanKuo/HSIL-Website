...
const tiles: Tile[] = [
  ...
  { span: "md:col-span-1", ratio: "aspect-[4/3]", src: phenocds, label: "PhenoCDS · 1st place", drift: 55 },
  { span: "md:col-span-1", ratio: "aspect-[4/3]", src: healthorithm, label: "The Healthorithm · 3rd place", drift: 25 },
  { span: "md:col-span-1", ratio: "aspect-[4/3]", src: judges, label: "The judging panel", drift: 45 },
  { span: "md:col-span-1", ratio: "aspect-[4/3]", src: mentor, label: "Mentor consultation", drift: 15 },

  // Row 3 — 4 standards (the day-of texture)
  { span: "md:col-span-1", ratio: "aspect-[4/3]", src: keynote, label: "Keynote · HSIL 7th Edition", drift: 50 },
  { span: "md:col-span-1", ratio: "aspect-[4/3]", src: podium, label: "Team pitch · NTU CPH podium", drift: 30 },
  { span: "md:col-span-1", ratio: "aspect-[4/3]", src: teamRoom, label: "Teams in the room · Day 1", drift: 40 },
  { span: "md:col-span-1", ratio: "aspect-[4/3]", src: profLee, label: "Prof. 李達宇 · faculty advisor", drift: 20 },
];
