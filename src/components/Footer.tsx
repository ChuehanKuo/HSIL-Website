    ...
    <div className="container mx-auto px-4">
      <div className="grid md:grid-cols-3 gap-8 items-center">
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="text-xs font-semibold text-white">Harvard T.H. Chan School of Public Health</p>
            <p className="text-xs opacity-70">Health Systems Innovation Lab</p>
          </div>
        </div>

        <div className="text-center">
          <p className="text-sm">台灣站由<span className="font-semibold text-white">國立臺灣大學</span>主辦</p>
        </div>
